"""Provides the GradientAnnealingEmitter."""
import itertools
...
class GradientAnnealingEmitter(EmitterBase):
    ...
    Args:
        ...
        seed (int): Value to seed the random number generator. Set to None to
            avoid a fixed seed.
    Raises:
        ValueError: If any of ``restart_rule``, or
    ...
    def __init__(self,
        ...
        self._num_parents = self.opt.batch_size // 2
    ...
    def _check_restart(self, num_parents):
        ...
        """
        if self._timeout != None and self._timeout <= self._restart_timer:
            return True
    ...
    def tell(self, solutions, objective_values, behavior_values, jacobian=None, metadata=None):
        ...
        parents = parents[:self._num_parents]
        weights = (np.log(self._num_parents + 0.5) -
