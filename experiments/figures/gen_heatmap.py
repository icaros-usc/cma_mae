...
algorithm_name = 'map_elites_100'
#algorithm_name = 'map_elites_line_100'
#algorithm_name = 'cma_me_imp_100'
#algorithm_name = 'cma_mae_100_0.01'
#algorithm_name = 'cma_mega_100'
#algorithm_name = 'cma_maega_100_0.01'

#algorithm_name = 'map_elites'
#algorithm_name = 'map_elites_line'
#algorithm_name = 'cma_me_imp'
#algorithm_name = 'cma_mae'
#algorithm_name = 'cma_mega_adam'
#algorithm_name = 'cma_maega'

archive_filename = f"../{domain_name}/results/beyonce_logs/{algorithm_name}/trial_0/archive_00010000.pkl"
...
for row in archive_data.itertuples():
    obj = np.sqrt(np.maximum(row.objective / 100.0, 0.0)) * 100.0
